                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Product Variant SKU <span class="text-error-500">*</span>
                            </label>
                            <select name="product_variant" id="productVariantSelect"
                                ...
                                @foreach ($productVariants as $item)
                                    <option value="{{ $item->id }}"
                                        ...
                                        {{ $item->sku }} (In Stock = {{ $item->stock_quantity }})
                                    </option>
                                @endforeach
                            </select>
                            <x-input-error :messages="$errors->get('product_variant')" class="mt-2" />
                        </div>
                       ...
                       dark:focus:border-brand-800" />
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Sold For <span class="text-error-500">*</span> <span class="text-gray-500">(NPR)</span>
                            </label>
                            <input type="number" step="1" min="0" id="sold_for" name="sold_for"
                                value="0" value="{{ old('sold_for') }}"
                                class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5
                       text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300
                       focus:outline-hidden focus:ring-3 focus:ring-brand-500/10
                       dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30
                       dark:focus:border-brand-800" />
                            <x-input-error :messages="$errors->get('sold_for')" class="mt-2" />
                        </div>
                    </div>
            ...
            rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                ...
                <div class="w-full overflow-x-auto">
                                        ...
                                        <td class="py-3">
                                            <div class="flex items-center">
                                                <div class="text-gray-500 text-theme-sm dark:text-gray-400 flex gap-2">
                                                    <a href="{{ route('admin.sales.show', $item->id) }}">
                 ...
                 C19.4,32.6,22.4,32.6,23.4,32.4z M11.1,20.7c0-5.2,4.4-9.4,9.9-9.4s9.9,4.2,9.9,9.4S26.5,30,21,30S11.1,25.8,11.1,20.7z" />
                                                    ...
                                                    @if(auth()->id() == $item->sale_entry_by || auth()->user()->hasRole('super-admin'))
                                                    ...
                                                    @endif
                                                    <form action="{{ route('admin.sales.destroy', $item->id) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
