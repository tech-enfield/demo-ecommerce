...
@section('title', 'Attribute Group | Store 9Nepal Admin Dashboard')
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <aside class="lg:col-span-1">
            <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/5">
                ...
                <form action="{{ route('admin.attributes.groups.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <aside class="lg:col-span-1">
            <div
                ...
                <div class="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-3 sm:items-center">
                    ...
                    <!-- Right: Search Form -->
                    <form action="{{ route('admin.attributes.groups.index') }}" method="GET"
            ...
            rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                ...
                <div class="w-full overflow-x-auto">
                                        ...
                                        <td class="py-3">
                                            <div class="flex items-center">
                                                <div class="text-gray-500 text-theme-sm dark:text-gray-400 flex gap-2">
                                                    {{-- <a href="{{ route('admin.attributes.groups.show', $item->id) }}">
                 ...
                 C19.4,32.6,22.4,32.6,23.4,32.4z M11.1,20.7c0-5.2,4.4-9.4,9.9-9.4s9.9,4.2,9.9,9.4S26.5,30,21,30S11.1,25.8,11.1,20.7z" />
                                                    ...
                                                    <a href="{{ route('admin.attributes.groups.edit', $item->id) }}">
                                                    ...
                                                    <form action="{{ route('admin.attributes.groups.destroy', $item->id) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
