...
@section('title', 'Attribute | Store 9Nepal Admin Dashboard')
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Attribute Group <span class="text-error-500">*</span>
                            </label>

                            <select name="attribute_group_id" id="attributeGroupId"
            ...
            rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                ...
                <div class="w-full overflow-x-auto">
                 ...
                 C19.4,32.6,22.4,32.6,23.4,32.4z M11.1,20.7c0-5.2,4.4-9.4,9.9-9.4s9.9,4.2,9.9,9.4S26.5,30,21,30S11.1,25.8,11.1,20.7z" />
                                                    ...
                                                    <form action="{{ route('admin.attributes.destroy', $item->id) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
