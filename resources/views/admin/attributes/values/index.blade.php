...
@section('title', 'Attribute Value | Store 9Nepal Admin Dashboard')
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Attribute <span class="text-error-500">*</span>
                            </label>
                            ...
                            <select name="attribute_id" id="attributeId"
                                ...
                                <option value="" selected disabled>Select an attribute group</option>
                        ...
                        <div>
                            ...
                            <input type="text" id="value" name="value" placeholder="Enter the value"
                                value="{{ old('value') }}"
        ...
        <aside class="lg:col-span-1">
            <div
                ...
                <div class="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-3 sm:items-center">
                    ...
                    <!-- Right: Search Form -->
                    <form action="{{ route('admin.attributes.values.index') }}" method="GET"
                        class="col-span-1 sm:col-span-2 flex gap-2">
                        <input type="text" name="attribute_name" placeholder="Search by attribute name."
                            value="{{ old('attribute_name') ?? request('attribute_name') }}"
                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5
            text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300
            focus:outline-hidden focus:ring-3 focus:ring-brand-500/10
            dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30
            ...
            rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                ...
                <div class="w-full overflow-x-auto">
                                                ...
                                                <div class="flex items-center gap-3">
                                                    <div>
                                                        <p
                                                            ...
                                                            {{ $item->attribute->attributeGroup->name }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td class="py-3">
                                            <div class="flex items-center">
                                                <div class="text-gray-500 text-theme-sm dark:text-gray-400 flex gap-2">
                                                    {{-- <a href="{{ route('admin.attributes.values.show', $item->id) }}">
                 ...
                 C19.4,32.6,22.4,32.6,23.4,32.4z M11.1,20.7c0-5.2,4.4-9.4,9.9-9.4s9.9,4.2,9.9,9.4S26.5,30,21,30S11.1,25.8,11.1,20.7z" />
                                                    ...
                                                    <a href="{{ route('admin.attributes.values.edit', $item->id) }}">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.attributes.values.destroy', $item->id) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
