...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="flex-grow-1 mx-4">
                <form class="search-bar d-flex align-items-center">
                    <input type="text" class="search-input" placeholder="What you are looking for?">
            ...
            <div class="d-flex align-items-center gap-4">
                <a href="#" class="d-flex align-items-center nav-link-custom">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('assets/img/banner/banner1.jpg') }}" class="banner-img">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('assets/img/banner/banner2.jpg') }}" class="banner-img">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('assets/img/banner/banner3.jpg') }}" class="banner-img">
                </div>
            </div>
            ...
            <div class="featured-products-bottom">
                <!-- <div class="row g-4">
                        <div class="col-lg-3">
                            <div class="featured-product-card">
                                <img src="{{ asset('assets/img/featured-products/fp-1.png') }}" alt="">
                                <h4 class="featured-product-title">Acer Nitro 5</h4>
                                <p class="featured-product-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi, expedita?</p>
                                <h5 class="featured-product-price">Rs <span>100000</span></h5>
                ...
                <div class="swiper featuredProductsSwiper">
                    <div class="swiper-wrapper">
                            ...
                            <div class="featured-product-card">
                                <div class="featured-product-card-img">
                                    <a href="assets/img/featured-products/featured-product-1.webp" class="glightbox-single">
                                        <img src="{{ asset('assets/img/featured-products/featured-product-1.webp') }}" alt="Acer Nitro 5">
                                    </a>
                                </div>
                                <h4 class="featured-product-title">Acer Nitro 5</h4>
                                <p class="featured-product-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi, expedita?</p>
                        ...
                        <!-- Repeat swiper-slide for each product -->
                        <div class="swiper-slide">
                            <div class="featured-product-card">
                                <div class="featured-product-card-img">
                                    <a href="assets/img/featured-products/featured-product-2.webp" class="glightbox-single">
                                        <img src="{{ asset('assets/img/featured-products/featured-product-2.webp') }}" alt="Acer Nitro 5">
                                    </a>
                                </div>
                                <h4 class="featured-product-title">Acer Nitro 5</h4>
                                <p class="featured-product-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi, expedita?</p>
                        ...
                        <div class="swiper-slide">
                            <div class="featured-product-card">
                                <div class="featured-product-card-img">
                                    <a href="assets/img/featured-products/featured-product-3.webp" class="glightbox-single">
                                        <img src="{{ asset('assets/img/featured-products/featured-product-3.webp') }}" alt="Acer Nitro 5">
                                    </a>
                                </div>
                                <h4 class="featured-product-title">Acer Nitro 5</h4>
                                <p class="featured-product-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi, expedita?</p>
                        ...
                        <div class="swiper-slide">
                            <div class="featured-product-card">
                                <div class="featured-product-card-img">
                                    <a href="assets/img/featured-products/featured-product-4.webp" class="glightbox-single">
                                        <img src="{{ asset('assets/img/featured-products/featured-product-4.webp') }}" alt="Acer Nitro 5">
                                    </a>
                                </div>
                                <h4 class="featured-product-title">Acer Nitro 5</h4>
                                <p class="featured-product-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi, expedita?</p>
                        ...
                        <div class="swiper-slide">
                            <div class="featured-product-card">
                                <div class="featured-product-card-img">
                                    <a href="assets/img/featured-products/featured-product-5.webp" class="glightbox-single">
                                        <img src="{{ asset('assets/img/featured-products/featured-product-5.webp') }}" alt="Acer Nitro 5">
                                    </a>
                                </div>
                                <h4 class="featured-product-title">Acer Nitro 5</h4>
                                <p class="featured-product-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi, expedita?</p>
                        ...
                        <div class="row">
                            <div class="col-lg-6 gaming-zone-right-item1">
                                <div class="gaming-zone-right-img">
                                    <a href="assets/img/gaming-zone/gaming-mouse.jpg" class="glightbox" data-gallery="gallery-2">
                            ...
                            <div class="col-lg-6 gaming-zone-right-item2">
                                <div class="gaming-zone-right-img">
                                    <a href="assets/img/gaming-zone/mechanical-keyboard.jpg" class="glightbox" data-gallery="gallery-2">
                                        <img src="{{ asset('assets/img/gaming-zone/mechanical-keyboard.jpg') }}" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="col-lg-6 gaming-zone-right-item3">
                                <div class="gaming-zone-right-img">
                                    <a href="assets/img/gaming-zone/gaming-headset.webp" class="glightbox" data-gallery="gallery-2">
                                        <img src="{{ asset('assets/img/gaming-zone/gaming-headset.webp') }}" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="col-lg-6 gaming-zone-right-item4">
                                <div class="gaming-zone-right-img">
                                    <a href="assets/img/gaming-zone/webcam.jpg" class="glightbox" data-gallery="gallery-2">
                        ...
                        <div class="accessories-card">
                            <div class="accessories-card-img">
                                <a href="assets/img/accessories/gaming-headset.webp" class="glightbox-single">
                                    <img src="{{ asset('assets/img/accessories/gaming-headset.webp') }}" alt="Gaming Headset">
                                </a>
                            </div>
                        ...
                        <div class="accessories-card">
                            <div class="accessories-card-img">
                                <a href="assets/img/accessories/gaming-mouse.webp" class="glightbox-single">
                                    <img src="{{ asset('assets/img/accessories/gaming-mouse.webp') }}" alt="Gaming Mouse">
                                </a>
                            </div>
                        ...
                        <div class="accessories-card">
                            <div class="accessories-card-img">
                                <a href="assets/img/accessories/mechanical-keyboard.webp" class="glightbox-single">
                                    <img src="{{ asset('assets/img/accessories/mechanical-keyboard.webp') }}" alt="Mechanical Keyboard">
                                </a>
                            </div>
                        ...
                        <div class="accessories-card">
                            <div class="accessories-card-img">
                                <a href="assets/img/accessories/laptop-stand.webp" class="glightbox-single">
                                    <img src="{{ asset('assets/img/accessories/laptop-stand.webp') }}" alt="Laptop Stand">
                                </a>
                            </div>
                        ...
                        <div class="accessories-card">
                            <div class="accessories-card-img">
                                <a href="assets/img/accessories/speaker.webp" class="glightbox-single">
                                    <img src="{{ asset('assets/img/accessories/speaker.webp') }}" alt="Portable Speakers">
                                </a>
                            </div>
                        ...
                        <div class="accessories-card">
                            <div class="accessories-card-img">
                                <a href="assets/img/accessories/laptopfan.webp" class="glightbox-single">
                                    <img src="{{ asset('assets/img/accessories/laptopfan.webp') }}" alt="Laptop Cooling Pad">
                                </a>
                            </div>
                ...
                <div class="swiper blogSwiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-card-img">
                                    <img src={{ asset('assets/img/blogs/electronics-guide.webp')}} class="blog-img" alt="Blog Image">
                                </div>
                                <div class="blog-content">
                                    <h4 class="blog-category">Electronics Guide</h4>
                                    <h5 class="blog-heading">Top 5 Laptops for Students in 2025</h5>
                                    <p class="blog-excerpt">A quick guide to help you choose the perfect laptop for study, work, and entertainment.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-card-img">
                                    <img src={{ asset('assets/img/blogs/laptop-guides.webp')}} class="blog-img" alt="">
                                </div>
                                <div class="blog-content">
                                    <h4 class="blog-category">Laptop Tips</h4>
                                    <h5 class="blog-heading">How to Increase Your Laptop Speed Instantly</h5>
                                    <p class="blog-excerpt">Simple upgrades and settings that can boost your laptop performance within minutes.</p>
                                    <a href="#" class="blog-read">Read Blog →</a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-card-img">
                                    <img src={{ asset('assets/img/blogs/smartphone-guides.webp')}} class="blog-img" alt="">
                                </div>
                                <div class="blog-content">
                                    <h4 class="blog-category">Smartphone Guide</h4>
                                    <h5 class="blog-heading">Best Phones Under NPR 25,000 in 2025</h5>
                                    <p class="blog-excerpt">Our top picks for budget smartphones with great performance and features.</p>
                                    <a href="#" class="blog-read">Read Blog →</a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-card-img">
                                    <img src={{ asset('assets/img/blogs/gaming-setup.webp')}} class="blog-img" alt="">
                                </div>
                                <div class="blog-content">
                                    <h4 class="blog-category">Gaming Setup</h4>
                                    <h5 class="blog-heading">Top Gaming Accessories You Must Have</h5>
                                    <p class="blog-excerpt">From RGB keyboards to premium gaming mice — upgrade your gaming experience.</p>
                                    <a href="#" class="blog-read">Read Blog →</a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-card-img">
                                    <img src={{ asset('assets/img/blogs/tech-updates.webp')}} class="blog-img" alt="">
                                </div>
                                <div class="blog-content">
                                    <h4 class="blog-category">Tech Updates</h4>
                                    <h5 class="blog-heading">Latest Gadget Releases of 2025</h5>
                                    <p class="blog-excerpt">A quick look at the newest phones, laptops, and accessories entering the market.</p>
                                    <a href="#" class="blog-read">Read Blog →</a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-card-img">
                                    <img src={{ asset('assets/img/blogs/home-tech.webp')}} class="blog-img" alt="">
                                </div>
                                <div class="blog-content">
                                    <h4 class="blog-category">Home Tech</h4>
                                    <h5 class="blog-heading">How to Build a Smart Home on a Budget</h5>
                                    <p class="blog-excerpt">Affordable smart gadgets to upgrade your home without spending too much.</p>
                                    <a href="#" class="blog-read">Read Blog →</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 benifits-item1">
                    <div class="benifits-inner align-items-center">
                        ...
                        <div class="benifits-inner-text">
                            <h3>Free Shipping</h3>
                            <p>Enjoy free shipping on all orders across Nepal — fast, reliable, and hassle-free delivery to your doorstep.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 benifits-item2">
                    <div class="benifits-inner align-items-center">
                        ...
                        <div class="benifits-inner-text">
                            <h3>100% Genuine</h3>
                            <p>Enjoy 100% genuine and original products — trusted quality, verified sources, and guaranteed authenticity on every purchase.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 benifits-item3">
                    <div class="benifits-inner align-items-center">
                        ...
                        <div class="benifits-inner-text">
                            ...
                            <p>Enjoy a 7-day easy return policy — simple, hassle-free, and designed to give you complete confidence while shopping.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 benifits-item4">
                    <div class="benifits-inner align-items-center">
                        ...
                        <div class="benifits-inner-text">
                            ...
                            <p>Shop without hesitation — enjoy a smooth, secure, and customer-friendly experience from browsing to checkout.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 benifits-item5">
                    <div class="benifits-inner align-items-center">
                        ...
                        <div class="benifits-inner-text">
                            ...
                            <p>Warranty on selected products — offering trusted coverage, reliable support, and peace of mind with every eligible purchase.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 benifits-item6">
                    <div class="benifits-inner align-items-center">
                        ...
                        <div class="benifits-inner-text">
                            ...
                            <p>Competitive prices on all products — enjoy great value, fair deals, and budget-friendly options every time you shop with us.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Contact Us -->
    <div class="contact-us pb-50">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="contact-us-left">
                        <div class="map-container" style="border-radius: 10px; overflow: hidden;">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3532.399044877207!2d85.32024947611366!3d27.70496302559544!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb1900418c62d5%3A0xdfd16c6905fd27d0!2sStore%209%20Nepal!5e0!3m2!1sen!2snp!4v1763977175399!5m2!1sen!2snp" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
        ...
        <div class="footer pt-50">
            <div class="container-fluid">
                <div class="footer-top">
                    <img src="{{ asset('assets/img/white-logo.png') }}" class="footer-logo">
                    <div class="footer-newsletter">
                        <input type="text" placeholder="Enter your email address">
                        <button class="red-theme-btn">Subscribe</button>
                ...
                <div class="footer-mid">
                    <div class="row">
                        <div class="col-lg-5">
                            <p class="footer-description">Welcome to Store9Nepal. A place to find the best electronic products for every taste and ocassion. Store9Nepal is the home to thousands of electronic products that you can possibly imagine from trending devices like laptops, tablets, smartphones to in-vogue electronic mainstays like smartwatches, neckbands, and more. Just put in what you're looking for, and youl'll be sure to find it here. What's more? We are bringing the products at irrestible prices, a hassle-free return policy, and quick delivery with free shipping on any order. So, What are you waiting for? Drag your cursor to the search bar, enter the product, and place your order at the cheapest price in town.</p>
                            <div class="footer-socials">
                                <a href="https://www.facebook.com/profile.php?id=61573457608553"><img src="{{ asset('assets/img/facebook.png') }}" alt=""></a>
                                <a href="https://www.instagram.com/store9nepal/#"><img src="{{ asset('assets/img/instagram.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-2 offset-lg-1">
                            ...
                            <a href="#">
                                <p class="footer-links">Warranty Policy</p>
                            </a>
                            <a href="#">
                                <p class="footer-links">Return Policy</p>
                            </a>
                            <a href="#">
                                <p class="footer-links">Blogs</p>
                            </a>
                            <a href="#">
                        ...
                        <div class="col-lg-2 ">
                            ...
                            <hr>
                            <a href="#">
                                <p class="footer-links">My Account</p>
                            </a>
                            <a href="#">
                                <p class="footer-links">My Cart</p>
                            </a>
                            <a href="#">
                                <p class="footer-links">My Order History</p>
                            </a>
                        </div>
                        <div class="col-lg-2 ">
                            ...
                            <hr>
                            <a href="#">
                                <p class="footer-links"><i class="bi bi-geo-alt-fill"></i> &nbsp;Putalisadak</p>
                            </a>
                            <a href="#">
                                <p class="footer-links"><i class="bi bi-telephone-fill"></i> &nbsp;9851000186</p>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-bottom pt-50">
                <p>©Copyright <script>
                    ...
                    </script> Store9Nepal. All Rights Reserved.</p>
                <p>Designed and Developed by <a href="https://techenfield.com">Tech Enfield</a></p>
            </div>
        </div>
        </div>
    </footer>
