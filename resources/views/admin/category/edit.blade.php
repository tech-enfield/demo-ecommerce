                ...
                <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-5">
                       ...
                       dark:focus:border-brand-800" />
                        ...
                        <div class="mb-4">
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Icon <span class="text-gray-500">(optional)</span>
                            </label>
                        ...
                        dark:border-gray-700 dark:bg-dark-900">
                           ...
                           hover:text-gray-900 dark:hover:text-white transition">
                                ...
                                <span id="file-name" class="text-sm text-gray-600 dark:text-gray-400">
                                    {{ old('icon') ? basename(old('icon')) : 'No file chosen' }}
                                </span>
                            </div>

                            <div class="mt-2 relative max-w-full flex">
                                <img id="icon-preview" src="{{ old('icon') ? asset('storage/' . old('icon')) : asset('storage/' . $category->icon) }}"
                                    class="max-h-32 rounded-lg shadow-md hidden" />
                                <button type="button" id="remove-icon" onclick="removeIcon()"
                        ...
                        dark:border-gray-700 dark:bg-dark-900">
                           ...
                           hover:text-gray-900 dark:hover:text-white transition">
                            ...
                            <div class="mt-2 relative max-w-full flex">
                                <img id="image-preview" src="{{ old('image') ? asset('storage/' . old('image')) : asset('storage/' . $category->image) }}"
                                    class="max-h-32 rounded-lg shadow-md hidden" />
                       ...
                       focus:outline-hidden focus:ring-3 focus:ring-brand-500/10
                       dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30
                       dark:focus:border-brand-800">{{ old('description') ?? $category->description }}</textarea>
                       ...
                       focus:outline-hidden focus:ring-3 focus:ring-brand-500/10
                       dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30
                       dark:focus:border-brand-800">{{ old('meta_description') ?? $category->meta_description }}</textarea>
            ...
            <div
                ...
                <div class="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-3 sm:items-center">
                    ...
                    <form action="{{ route('admin.categories.index') }}" method="GET"
                        ...
                        <input type="text" name="name" placeholder="Search by categories name."
