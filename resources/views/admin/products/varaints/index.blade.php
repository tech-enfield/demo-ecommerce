        ...
        <div
            ...
            <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center justify-between w-full sm:w-auto">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
                        Product Variant
                    </h3><a href="{{ route('admin.products.variants.create') }}">
            ...
            rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                ...
                <a href="{{ route('admin.products.variants.create') }}">
                    <button class="hidden sm:block bg-success-500 px-5 py-1 rounded-lg text-white">
                        Create
                    </button>
                </a>
            </div>
                                    ...
                                    <td class="py-3">
                                        <div class="flex items-center">
                                            <div class="text-gray-500 text-theme-sm dark:text-gray-400 flex gap-2">
                                                <a href="{{route('admin.products.variants.assign.color.family', $item->id)}}">
                                                    <button>Color</button>
                                                </a>
                                                <a href="{{ route('admin.products.variants.show', $item->id) }}">
                                                ...
                                                <a href="{{ route('admin.products.variants.edit', $item->id) }}">
                                                ...
                                                <form action="{{ route('admin.products.variants.destroy', $item->id) }}"
                                                    method="POST">
                                                    @csrf @method('DELETE')
