                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 mt-2">
                            <span
                                ...
                                {{ $category->status === 'active' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' }}">
                ...
                <div class="grid grid-cols-1 gap-4 mb-6">
                        ...
                        <div class="text-center">
                            ...
                            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4">
                                <img src="{{ asset('storage/' . $category->image) }}"
                                    class="max-h-48 mx-auto rounded-lg shadow-md" alt="{{ $category->name }}" />
                            </div>
                        </div>
                    @endif
                    ...
                    @if ($category->icon)
                        <div class="text-center">
                            ...
                            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4">
                                <img src="{{ asset('storage/' . $category->icon) }}" class="h-16 mx-auto"
