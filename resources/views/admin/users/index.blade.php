                                                    ...
                                                    <a href="{{ route('admin.assign.role', $item->id) }}">
                                                        <button title="assign role to {{ $item->name }}">
                                                            <svg width="16px" height="16px" viewBox="0 0 24 24"
                                                                ...
                                                                <path d="M7 14h10M7 11h10M7 17h6" class="stroke-gray-900 dark:stroke-gray-100"
                                                                    stroke-width="1.5" stroke-miterlimit="10"
                                                                ...
                                                                <path d="M16 3v2.2a.8.8 0 0 1-.8.8H8.8a.8.8 0 0 1-.8-.8V3"
                                                                     stroke-width="1.5" class="stroke-gray-900 dark:stroke-gray-100"
                                                                    stroke-miterlimit="10" stroke-linecap="round" />
                                                                <path
                                                                    d="M18.6 3H5.4A2.4 2.4 0 0 0 3 5.4v15.2A2.4 2.4 0 0 0 5.4 23h13.2a2.4 2.4 0 0 0 2.4-2.4V5.4A2.4 2.4 0 0 0 18.6 3Z"
                                                                     stroke-width="1.5" class="stroke-gray-900 dark:stroke-gray-100"
                                                                    stroke-miterlimit="10" />
                                                                <path d="M14 3a2 2 0 1 0-4 0"
                                                                    stroke-width="1.5" stroke-miterlimit="10" class="stroke-gray-900 dark:stroke-gray-100"
                                                                    stroke-linecap="round" />
                                                            </svg>
                                                        </button>
                                                    </a>
